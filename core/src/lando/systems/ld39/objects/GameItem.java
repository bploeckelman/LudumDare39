...
public class GameItem extends GameObject {
    ...
    public static class ItemData {
        ...
        public ItemData(String textureImage, int pickupId, float inRoadPercentage, SoundManager.SoundOptions pickupSoundType) {
            this(textureImage, true, 0, true, inRoadPercentage, pickupSoundType);
    ...
    public static void load() {
        ...
        obstacles.add(new ItemData("palmtree", false, 100, false, 0, SoundManager.SoundOptions.crash_1));
        obstacles.add(new ItemData("palmtree2", false, 100, false, 0, SoundManager.SoundOptions.crash_1));
        obstacles.add(new ItemData("palmtree3", false, 100, false, 0, SoundManager.SoundOptions.crash_1));
...
//        obstacles.add(new ItemData("barricade2", false, 10, true, 0.9f, null));
        obstacles.add(new ItemData("treeA", false, 100, false, 0, SoundManager.SoundOptions.crash_1));
        obstacles.add(new ItemData("treeC", false, 100, false, 0, SoundManager.SoundOptions.crash_1));
        obstacles.add(new ItemData("treeD", false, 100, false, 0, SoundManager.SoundOptions.crash_1));

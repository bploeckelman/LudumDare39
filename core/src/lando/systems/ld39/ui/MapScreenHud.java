...
public class MapScreenHud {
    ...
    private static final float TIME_CASH_IN_DISTANCE = .75f;
    private static final float TIME_CASH_IN_MONEY_COLLECTED = .75f;
    private static final float TIME_CASH_IN_POWERUPS = .75f;
